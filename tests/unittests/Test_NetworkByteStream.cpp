...
PFTEST_CREATE(NetworkByteStream_Primitive)
{
...
PFTEST_CREATE(NetworkByteStream_Variable)
{    
    std::byte buff[128] = { std::byte(0) };
    NetworkByteStream wstream(NetworkByteStream::Mode::Write, buff, sizeof(buff));
    NetworkByteStream rstream(NetworkByteStream::Mode::Read, buff, sizeof(buff));
...
PFTEST_CREATE(NetworkByteStream_BytesString)
{
...
PFTEST_CREATE(NetworkByteStream_Overflow)
{
...
PFTEST_CREATE(NetworkByteStream_Seek)
{
    std::byte buff[64] = { std::byte(0) };
